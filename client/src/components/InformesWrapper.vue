<template>
    <div>
      ...
      <div v-else>
        <InformesMedico v-if="userType === 'Médico'" />
        <InformesPaciente v-if="userType === 'Paciente'" />
  ...
  import InformesMedico from './InformesMedico.vue';
  import InformesPaciente from './InformesPaciente.vue';
  ...
  export default {
    ...
    async created() {
      ...
      if (authStore.isAuthenticated) {
        ...
        if (['Paciente', 'Médico'].includes(tipo)) {
          this.userType = tipo;
        } else {
