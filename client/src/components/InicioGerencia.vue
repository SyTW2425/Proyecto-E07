<template>
    ...
    <div class="button-container">
      ...
      <a href="/departamentos" style="text-decoration: none; color: inherit;">
        <button class="caja-contenido" href="#">
          <div class="circle">
      ...
      <a href="/prestaciones" style="text-decoration: none; color: inherit;">
        <button class="caja-contenido" href="#">
          <div class="circle">
            <svg
              width="60"
          ...
          <br>
          <span class="button-text">Prestaciones</span>
        </button>
      </a>
      
      <a href="/aseguradoras" style="text-decoration: none; color: inherit;">
        <button class="caja-contenido" href="#">
          <div class="circle">
            <svg
              width="60"
